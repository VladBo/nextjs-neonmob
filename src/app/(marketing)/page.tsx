    ...
    <>
      <section className="container grid items-center justify-center gap-6 pt-6 pb-8 md:pt-10 md:pb-12 lg:pt-16 lg:pb-24">
        ...
        <div className="flex gap-4">
          ...
          <Link
            href="/"
            className="focus:ring-brand-500 relative inline-flex h-11 items-center rounded-md border border-slate-200 bg-white px-8 py-2 font-medium text-slate-900 transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2"
          >
            Lorem ipsum
          </Link>
        </div>
