...
const Hero = () => {
  return (
    <>
      <section className="grid w-full items-center justify-center gap-6 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 pt-6 pb-8 md:pt-10 md:pb-12 lg:pt-16 lg:pb-24">
